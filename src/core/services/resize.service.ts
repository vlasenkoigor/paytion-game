...
export const FitScaleStrategy: ScaleStrategy = {
  calculateCanvasSize: function (_clientSize: WidthHeight, gameSize: WidthHeight): WidthHeight {
    return {
  ...
  calculateGameAreaRect: function (_canvasSize: WidthHeight, gameSize: WidthHeight): Rect {
    return {
      x: 0,
      y: 0,
      width: gameSize.width,
